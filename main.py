...
async def portfolio():
    ...
    <div class="student-info">
        <p> <strong>Student Name:</strong> Irene Njuguna</p> 👩‍🎓
        <p> <strong>Admission Number:</strong> 
            <span class="admission">C027-01-0834/2024</span>
        </p>
        <p> <strong>Email:</strong> irenenjuguna707@gmail.com</p> 📧
    </div>
    ...
    <div class="footer">
        ...
        <p style="font-size: 0.8em;"> Click on any assignment link to view the complete ⚠️ source code on GitHub</p>
    </div>
    </div>
    </body>
    </html>
